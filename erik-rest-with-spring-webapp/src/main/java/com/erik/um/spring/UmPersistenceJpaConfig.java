...
@ComponentScan({ "com.erik.um.persistence" })
@PropertySource({ "classpath:persistence-${persistenceTarget:h2}.properties" })
@EnableJpaRepositories(basePackages = "com.erik.um.persistence.dao")
public class UmPersistenceJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "com.erik.um" });
